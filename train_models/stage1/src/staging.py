"""Stage the Stage1 dataset onto fast local storage for the duration of a run."""
...
STAGE_FILE_NAMES = ("ct.npy", "vertebra_mask.npy")
_STAGE_DIR_PREFIX = "vai-stage1-data"
...
def _iter_relative_files(source_dir: Path) -> list[Path]:
    """Return dataset-relative paths for the files each sample needs."""
    return [
